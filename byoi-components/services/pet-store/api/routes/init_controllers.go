...
import (
	"github.com/wso2/choreo-sample-apps/byoi-components/services/pet-store/internal/config"
	"github.com/wso2/choreo-sample-apps/byoi-components/services/pet-store/internal/controllers"
